...
const enOverrides: Record<string, string> = {
  ...
  'settings.modeLabel': 'Detection mode',
  'settings.modeHelp': 'Switch between regex and semantic when creating a rule, regardless of which list you came from.',
  'settings.modeOption.regex': 'Best for fixed formats with instant validation.',
  'settings.modeOption.semantic': 'Best for meaning-based content understood from context.',
  ...
  'settings.ruleFamilyLabel': 'Color family',
  'settings.ruleFamily.regex': 'Uses the regex family shared across text rule surfaces.',
  'settings.ruleFamily.semantic': 'Uses the semantic family shared across text and image semantic detection.',
