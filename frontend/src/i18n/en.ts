...
'page.batchImage.sub': 'Scans and image recognition',
  ...
  'batchWizard.step1.textRedactionMode': 'Text redaction style',
  'batchWizard.step1.imageRedactionMode': 'Image redaction style',
  ...
  'batchWizard.step1.textModeStructuredLine1': 'Replace entities with standard labels so the whole batch stays consistent.',
  'batchWizard.step1.textModeStructuredLine2': 'Best for review, audits, and side-by-side checking later.',
  'batchWizard.step1.textModeStructuredLine3': 'Choose this when you want the output to feel neat and explicit.',
  'batchWizard.step1.textModeSmartLine1': 'Generate replacements that read more like natural text.',
  'batchWizard.step1.textModeSmartLine2': 'Best for outward-facing files or documents that will keep circulating.',
  'batchWizard.step1.textModeSmartLine3': 'Choose this when overall readability matters most.',
  ...
  'batchWizard.step1.imageTypes': 'Image features',
  'batchWizard.step1.noTextSelection': 'No text entities are selected yet.',
  'batchWizard.step1.noVisionSelection': 'No image rules are selected yet.',
...
const enOverrides: Record<string, string> = {
  ...
  'batchHub.mode.text.summaryValue': 'Text rules and replacement strategy',
  'batchHub.mode.image.title': 'Image batch',
  'batchHub.mode.image.desc': 'Best for scans, images, and runs led by region detection.',
  'batchHub.mode.image.tag1': 'Scans / images',
  'batchHub.mode.image.tag2': 'Image preset',
  ...
  'batchHub.mode.smart.summaryValue': 'One review path for text and image output',
  ...
  'playground.group.semantic': 'Semantic',
  ...
  'settings.preview.signatureRegion': 'Signature region',
