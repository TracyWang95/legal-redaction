...
const enBase: Record<string, string> = {
  ...
  'batchWizard.step4.pagesVisitedHint': 'You must view every page before confirming',
...
const enOverrides: Record<string, string> = {
  ...
  'auth.setup.description': 'This deployment is protected. Set the first admin password to continue.',
